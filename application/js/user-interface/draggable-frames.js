...
let frameInfoOffsetLeft = 0,
   frameInfoOffsetTop = 0;
...
frameInfo.addEventListener('mousedown', (e) => {
   ...
   if (
      !(
         frameInfoOffsetLeft > rect.width / 2 - 17 &&
         frameInfoOffsetTop > rect.height / 2 - 17
      )
   ) {
...
let frameModelTreeOffsetLeft = 0,
   frameModelTreeOffsetTop = 0;
frameModelTree.addEventListener('mousedown', (e) => {
   ...
   if (
      !(
         frameModelTreeOffsetLeft > rect.width / 2 - 17 &&
         frameModelTreeOffsetTop > rect.height / 2 - 17
      )
   ) {
...
const dragFrameInfo = (e) => {
   ...
   newPosLeft =
      newPosLeft + rect.width / 2 > window.innerWidth
         ? window.innerWidth - rect.width / 2
         : newPosLeft;
   newPosTop =
      newPosTop + rect.height / 2 > window.innerHeight
